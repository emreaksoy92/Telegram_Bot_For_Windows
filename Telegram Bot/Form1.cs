...
namespace Telegram_Bot
{
    public partial class Form1 : Form
    {
        ...
        //GoogleAPI.GoogleApi ga = new GoogleAPI.GoogleApi(Properties.Settings.Default.GoogleToken);
